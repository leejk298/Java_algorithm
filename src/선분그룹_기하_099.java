...
public class 선분그룹_기하_099 {
    ...
    public static int find(int i) { // find
    ...
    public static void union(int i, int j) { // 합집합
    ...
    public static int CCW(long x1, long y1, long x2, long y2, long x3, long y3) { // CCW 연산
    ...
    public static boolean isOverlab(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) { // 겹치는 지
    ...
    public static boolean isCross(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) { // 교차인 지
