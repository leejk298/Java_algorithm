...
public class 최소값2_SegmentTree_072 {
    static int N, M;    // 크기
    static int treeSize, leafNodeStartIndex;    // 크기, 시작인덱스
    static long tree[]; // 트리

    public static void setTree(int i) { // 세그먼트 트리 만들기
    ...
    public static long getMin(int S, int E) { // 최소값
    ...
    public static void main(String[] args) throws IOException {
        ...
        treeSize = (int) Math.pow(2, treeHeight + 1); // 배열크기: 2^k * 2 = 2^(k+1)
        leafNodeStartIndex = treeSize / 2; // 원본데이터(리프노드)시작 인덱스
