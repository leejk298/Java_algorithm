...
public class 방정식_확장유클리드호제법_045 {
    public static long[] execute(int a, int b) { // 유클리드호제법 함수
    ...
    public static long gcd(int a, int b) { // 최대공약수
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (c % gcd != 0) // c가 최대공약수의 배수가 아니면
            ...
            long res[] = execute(a, b); // 나머지 b가 0이 될 때까지 유클리드호제법 함수 호출
