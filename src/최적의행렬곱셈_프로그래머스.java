...
public class 최적의행렬곱셈_프로그래머스 {
    public static void main(String[] args) {
        ...
        System.out.println(solution.solution(new int[][]{{5, 3}, {3, 10}, {10, 6}, {6, 11}, {11, 13}, {13, 4}}));
    }

    static class Solution {
        // 멤버 변수
        static int[][] matrix; // dp 배열
        static int[][] memo;   // 메모이제이션 배열

        // 멤버 함수
        public static int memoization(int s, int e) {
        ...
        public static int matrixMul(int s, int e) {
